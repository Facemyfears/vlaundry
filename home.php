      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a <?php if ($_SESSION['admin']){?>href="?page=pengguna" <?php }?> style="cursor : pointer" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a <?php if ($_SESSION['admin'] || $_SESSION['kasir']){?>href="?page=pengguna" <?php }?>  style="cursor : pointer" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
